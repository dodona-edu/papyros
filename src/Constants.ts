...
export const VISUALIZE_AREA_ID = addPapyrosPrefix("visualize-area");
...
export const PREV_BTN_ID = addPapyrosPrefix("prev-btn");
export const NEXT_BTN_ID = addPapyrosPrefix("next-btn");
export const SLIDER_AREA_ID = addPapyrosPrefix("slider-area");
