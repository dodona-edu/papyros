...
function multiplyLists(a: any[], b:any[]) {
  var ret: any[] = [];
  for (var i = 0; i < a.length; i++) {
    for (var j = 0; j < b.length; j++) {
      var elt: any[] = a[i];
      // flatten list
      if ($.isArray(elt)) { // Leaving this temporarily in
...
export class ExecutionVisualizer {
  ...
  updateOutputMini() {
    ...
    // Added this because otherwise updateOutputCallback will never be called with hideCode: true
    if (this.params.updateOutputCallback) {
      this.params.updateOutputCallback(this);
    }
  }
  ...
  constructor(owner, domRoot, domRootD3, nSteps) {
    ...
    var navHTML = '<div id="navControlsDiv">\
                     ...
                     <div id="vcrControls">\
                       ...
                       <button class="_tw-m-5" id="jmpStepFwd", type="button">Forward &gt;</button>\
